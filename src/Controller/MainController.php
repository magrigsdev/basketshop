...
use App\Services\NavbarManager;
...
{
    #[Route('/', name: 'app_main')]
    public function main(NavbarManager $navbar_manager): Response
    {
        $nav_actived = $navbar_manager->getNavActive('Main');
        ...
        return $this->render('main/index.html.twig', [
            ...
            'nav_actived' => $nav_actived, // Pass the active navigation item
